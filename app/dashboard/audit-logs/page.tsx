    ...
    <DashboardLayout>
      <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
        <div style={{ 
          ...
          <div>
            <h1 style={{ margin: 0, color: '#1976d2' }}>Audit Log Management</h1>
            <p style={{ margin: '5px 0 0 0', color: '#666' }}>
              Track all database changes with complete audit trail
            </p>
          </div>
          <button
        ...
        <AuditLogList key={refreshKey} onEdit={handleEdit} />
      </div>
    </DashboardLayout>
  );
}