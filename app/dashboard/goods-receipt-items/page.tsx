...
import GoodsReceiptItemsList from '@/components/GoodsReceiptItemsList';
import GoodsReceiptItemsForm from '@/components/GoodsReceiptItemsForm';
    ...
    <DashboardLayout>
      <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
        <div style={{ 
          ...
          <div>
            <h1 style={{ margin: 0, color: '#1976d2' }}>Goods Receipt Items Management</h1>
            <p style={{ margin: '5px 0 0 0', color: '#666' }}>
              Manage individual items in goods receipt notes with batch and expiry tracking
            </p>
          </div>
          <button
        ...
        <GoodsReceiptItemsList key={refreshKey} onEdit={handleEdit} />
      </div>
    </DashboardLayout>
  );
}