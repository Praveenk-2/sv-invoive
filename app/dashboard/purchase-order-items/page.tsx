...
import PurchaseOrderItemsList from '@/components/PurchaseOrderItemsList';
    ...
    <DashboardLayout>
      <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
        <div style={{ 
          ...
          <div>
            <h1 style={{ margin: 0, color: '#1976d2' }}>Purchase Order Items Management</h1>
            <p style={{ margin: '5px 0 0 0', color: '#666' }}>
              Manage purchase order line items with automatic total calculation
            </p>
          </div>
          <button
        ...
        {showForm && (
                ...
                <PurchaseOrderItemsList key={refreshKey} onEdit={handleEdit} />
              </div>
            </DashboardLayout>
          );
        }